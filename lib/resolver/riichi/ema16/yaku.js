...
export const EMA16_MIXED_YAKUMAN = [
    {
        ...Tenhou,
        yakuman: true,
    },
...
export const EMA16_CLASSIC_YAKUMAN = [
    {
        ...ChuurenPoutou,
        yakuman: true,
    },
...
export const EMA16_NORMAL_CHII_TOITSU_YAKU = {
    ...ChiiToitsuUnique,
    yakuman: false,
    han: 2,
    concealedMajoration: false
};
export const EMA16_NORMAL_MIXED_YAKU = [
    {
        ...Riichi,
        yakuman: false,
        han: 1,
...
export const EMA16_NORMAL_CLASSIC_YAKU = [
    {
        ...Pinfu,
        yakuman: false,
        han: 1,
